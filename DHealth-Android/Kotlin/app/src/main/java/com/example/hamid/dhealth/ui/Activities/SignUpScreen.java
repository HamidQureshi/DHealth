                        ...
                        .subscribe(new Observer<Response<String>>() {
                            ...
                            public void onNext(Response<String> stringResponse) {
                                ...
                                if (status_code == 200) {
                                    ...
                                    preferenceManager.writeToPref(SignUpScreen.this, PreferenceKeys.INSTANCE.getSP_APP_TOKEN(), token);
                                    preferenceManager.writeToPref(SignUpScreen.this, PreferenceKeys.INSTANCE.getSP_LOGGEDIN(), true);
                                    preferenceManager.writeToPref(SignUpScreen.this, PreferenceKeys.INSTANCE.getSP_EMAIL(), inputEmail.getText().toString());
