                                ...
                                if (status_code == 200) {
                                    ...
                                    try {
                                        ...
                                        if (stream != null) {
                                            ...
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_IDENTITY(), identity);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_NAME(), first_name);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_LAST_NAME(), last_name);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_EMAIL(), email);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_DOB(), date_of_birth);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_PHONENO(), phone_number);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_ADDRESS(), address);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_GENDER(), gender);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_ENCRYPTION(), security);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_PROFILE_TYPE(), profile_type);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_PROFILEPIC(), dp);
                                            preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_PROFILEFINISHED(), true);
                                    ...
                                    preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_APP_TOKEN(), token);
                                    preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_LOGGEDIN(), true);
                                    preferenceManager.writeToPref(LoginScreen.this, PreferenceKeys.INSTANCE.getSP_EMAIL(), inputEmail.getText().toString());
