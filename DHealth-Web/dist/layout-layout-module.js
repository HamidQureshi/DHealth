...
var LayoutComponent = /** @class */ (function () {
    ...
    LayoutComponent.prototype.ngOnInit = function () {
        var header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
            ...
            Authorization: _helper_ledgerhelper__WEBPACK_IMPORTED_MODULE_3__["LedgerHelper"].token
    ...
    LayoutComponent.prototype.getDoctorList = function (headers) {
        var _this = this;
        this.getDoctor(headers)
            ...
            if (data.status == 200) {
                ...
                // this.open();
                for (var i = 0; i < data.body.streams.length; i++) {
                    var display = void 0;
                    if (data.body.streams[i].dp == null || data.body.streams[i].dp.length < 10) {
                        display = _this.placeholder_img;
                    }
                    else {
                ...
                _this.ledgerHelper.userList = JSON.stringify(_this.users);
            }
            else {
    ...
    LayoutComponent.prototype.getAssignedPatientList = function (headers) {
        this.getPatient(headers)
            .subscribe(function (data) {
            console.log(data);
        });
    };
    LayoutComponent.prototype.getReportList = function (headers) {
        var _this = this;
        this.getReport(headers).subscribe(function (data) {
            console.log(data);
            if (data.status == 200) {
                // this.message = data.body.resp.desc;
                // this.open();
                ...
                for (var i = 0; i < data.body.streams[0].reports.length; i++) {
                    var report = {
                        id: '' + (i + 1),
                ...
                console.log('after save 1--' + JSON.stringify(_this.reports));
                console.log('after save --' + _this.ledgerHelper.reports);
            }
            else {
                // this.message = ' Something went wrong! ';
                // this.open();
    ...
    LayoutComponent.prototype.getDoctor = function (header) {
        return this.http.get(this.getDoctorURL, { headers: header, observe: 'response' });
    };
    LayoutComponent.prototype.getPatient = function (header) {
        return this.http.get(this.getPatientURL, { headers: header, observe: 'response' });
    };
    LayoutComponent.prototype.getReport = function (header) {
        return this.http.get(this.getReportURL, { headers: header, observe: 'response' });
    };
    LayoutComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_helper_ledgerhelper__WEBPACK_IMPORTED_MODULE_3__["LedgerHelper"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], angular_persistence__WEBPACK_IMPORTED_MODULE_2__["PersistenceService"]])
    ], LayoutComponent);
