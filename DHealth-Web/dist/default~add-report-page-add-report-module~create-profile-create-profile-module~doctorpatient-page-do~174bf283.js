(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~add-report-page-add-report-module~create-profile-create-profile-module~doctorpatient-page-do~174bf283"],{

/***/ "./src/app/helper/ledgerhelper.ts":
/*!****************************************!*\
  !*** ./src/app/helper/ledgerhelper.ts ***!
  \****************************************/
/*! exports provided: LedgerHelper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LedgerHelper", function() { return LedgerHelper; });
/* harmony import */ var angular_persistence__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! angular-persistence */ "./node_modules/angular-persistence/index.js");
...
var LedgerHelper = /** @class */ (function () {
    function LedgerHelper(persistenceService) {
        this.persistenceService = persistenceService;
    }
    LedgerHelper_1 = LedgerHelper;
    Object.defineProperty(LedgerHelper, "key", {
        get: function () {
            return JSON.parse(localStorage.getItem('key:' + LedgerHelper_1.email));
        },
        set: function (key) {
            localStorage.setItem('key:' + LedgerHelper_1.email, JSON.stringify(key));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(LedgerHelper, "token", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "address", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "date_of_birth", {
        get: function () {
            return localStorage.getItem('date_of_birth');
        },
        set: function (date_of_birth) {
            localStorage.setItem('date_of_birth', date_of_birth);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(LedgerHelper, "dp", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "email", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "first_name", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "last_name", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "full_name", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "gender", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "phone_number", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "profile_type", {
        get: function () {
            return localStorage.getItem('profile_type');
        },
        set: function (profile_type) {
            localStorage.setItem('profile_type', profile_type);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(LedgerHelper, "resecurityports", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "security", {
    ...
    Object.defineProperty(LedgerHelper, "_id", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "profileCreated", {
        get: function () {
            return localStorage.getItem('profileCreated');
        },
        set: function (profileCreated) {
            localStorage.setItem('profileCreated', profileCreated);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(LedgerHelper, "isLoggedin", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper, "report", {
        get: function () {
...
//# sourceMappingURL=default~add-report-page-add-report-module~create-profile-create-profile-module~doctorpatient-page-do~174bf283.js.map