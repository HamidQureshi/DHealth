...
public class UploadFileActivity extends AppCompatActivity {
    ...
    private void initLayout() {
        ...
        String firstName = preferenceManager.readFromPref(this, PreferenceKeys.SP_NAME, "");
        String lastName = preferenceManager.readFromPref(this, PreferenceKeys.SP_LAST_NAME, "");
