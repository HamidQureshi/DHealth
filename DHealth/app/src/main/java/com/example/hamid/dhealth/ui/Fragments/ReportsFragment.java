...
public class ReportsFragment extends Fragment implements View.OnClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        reports = mViewModel.getReportList().getValue();
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
    ...
    private void initLayouts() {
        ...
        if (preferenceManager.readFromPref(getActivity(), PreferenceKeys.SP_PROFILE_TYPE, PreferenceKeys.LBL_DOCTOR).equalsIgnoreCase(PreferenceKeys.LBL_DOCTOR)) {
            fab_create_file.setVisibility(View.GONE);
        }
...
//                Utils.showKeyboard(getActivity());
    ...
    private void populateList() {
        ...
        if (preferenceManager.readFromPref(getActivity(), PreferenceKeys.SP_PROFILE_TYPE, PreferenceKeys.LBL_DOCTOR).equalsIgnoreCase(PreferenceKeys.LBL_DOCTOR)) {
            ...
            mViewModel.getReportsListFromServer(preferenceManager.readFromPref(getActivity(), PreferenceKeys.SP_APP_TOKEN, "null"));
        }
