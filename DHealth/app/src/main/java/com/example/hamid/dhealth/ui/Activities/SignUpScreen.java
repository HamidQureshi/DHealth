                        ...
                        .subscribe(new Observer<Response<String>>() {
                            ...
                            public void onNext(Response<String> stringResponse) {
                                ...
                                if (status_code == 200) {
                                    ...
                                    preferenceManager.writeToPref(SignUpScreen.this, PreferenceKeys.SP_APP_TOKEN, token);
                                    preferenceManager.writeToPref(SignUpScreen.this, PreferenceKeys.SP_LOGGEDIN, true);
                                    preferenceManager.writeToPref(SignUpScreen.this, PreferenceKeys.SP_EMAIL, inputEmail.getText().toString());
